...
export function TimelineHeader({ className, columnLabel = "Row" }: TimelineHeaderProps) {
  const { config, pixelsPerMinute, timelineWidth, columnRef } = useTimeline()
  ...
  return (
    <div data-slot="timeline-header" className={cn("sticky top-0 z-10 bg-background border-b w-fit", className)}>
      <div className="flex h-12">
        ...
        <div data-slot="timeline-header-markers" className="relative shrink-0" style={{ width: `${timelineWidth}px` }}>
...
export function TimelineRow({
  ...
  return (
    ...
    >
      ...
      {/* Timeline grid */}
      <div data-slot="timeline-row-grid" className="relative shrink-0" style={{ width: `${timelineWidth}px` }}>
        {/* Grid lines */}
