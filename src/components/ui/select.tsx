  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <span className="icon-[solar--alt-arrow-down-linear] pointer-events-none size-4 text-muted-foreground" />
    ...
    >
      <span className="pointer-events-none absolute right-2 flex size-4 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <span className="icon-[solar--check-read-linear] pointer-events-none size-4" />
        </SelectPrimitive.ItemIndicator>
      </span>
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <span className="icon-[solar--alt-arrow-up-linear] size-4" />
    </SelectPrimitive.ScrollUpButton>
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <span className="icon-[solar--alt-arrow-down-linear] size-4" />
    </SelectPrimitive.ScrollDownButton>
  )
}
