...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <span data-slot="accordion-trigger-icon" className="icon-[solar--alt-arrow-down-linear] pointer-events-none size-4 shrink-0 group-aria-expanded/accordion-trigger:hidden" />
        <span data-slot="accordion-trigger-icon" className="icon-[solar--alt-arrow-up-linear] pointer-events-none hidden size-4 shrink-0 group-aria-expanded/accordion-trigger:inline" />
      </AccordionPrimitive.Trigger>
