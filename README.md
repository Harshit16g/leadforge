...
LeadForge is a Next.js-based CRM prototype for automotive sales teams to capture leads, manage pipeline stages, assign sales reps, track activities, and monitor performance.
